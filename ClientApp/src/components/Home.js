...
`;
  ...
  useGSAP(() => {
    // gsap code here...
    gsap.to("#test", { rotation: 180 }); // <-- automatically reverted
  ...
  return (
    <>
      ...
      <ReactCanvasConfetti refConfetti={getInstance} style={canvasStyles} />
          <div className='bg-photo bg-bottom bg-fixed bg-cover pb-16 pt-10 shadow-lg '>
        {/* style={{ clipPath: 'polygon(0 0, 100% 0, 100% 90%, 52% 100%, 0 92%)' }} */}
        <div className='px-5  text-center' onClick={() => set((state) => !state)}>
          <BaseTitle open={open}>
            <span>Friwo </span>
            <span>Fashion </span>
            <span>Design </span>
